...
class SimpleVisualizationTool(QWidget):
    ...
    def read_config_from_xml(self):
        try:
            ...
            return ftp_server, username, password, remote_file1, local_file1, remote_file2, local_file2
    ...
    def load_and_visualize_data(self):
        ftp_server, username, password, remote_file1, local_file1, remote_file2, local_file2 = self.read_config_from_xml()
